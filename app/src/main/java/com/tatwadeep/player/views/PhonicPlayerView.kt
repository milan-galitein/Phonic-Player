package com.tatwadeep.player.views
...
import com.tatwadeep.player.R
import com.tatwadeep.player.handler.MediaPlayerHolder
import com.tatwadeep.player.listener.OnPlayerViewClickListener
import com.tatwadeep.player.listener.OnPlaybackInfoListener
import com.tatwadeep.player.utils.PlayerTarget
import com.tatwadeep.player.utils.PlayerAdapter
import com.tatwadeep.player.utils.PlayerUtils
import java.io.File
import java.util.*
    ...
    val folderDirectory: String
        get() {
            ...
            try {
                ...
                val folder = File(
                    SDCardRoot,
                    mContext!!.getString(R.string.app_name) + "/audio/"
                )
